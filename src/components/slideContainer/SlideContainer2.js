...
import slideItems2 from "../constants/slideItems2";
const length = slideItems2.length;
let slide_width = 1084;
let slideStart = 6336.5;

function SlideContainer2() {
        ...
        <div className ="slickListWrapper">
          <div className ="slickList">
            <div className ="slickTrack" ref={slideRef} slidesize={slidesize}>
              <SlideList slides={slideItems2} counter={counter} slidesize={slidesize} />
            </div>
          </div>
